...
const ResetPassword: React.FC<ResetPasswordProps> = () => {
    ...
    <form className="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" onSubmit={handleReset}>
        ...
        <p className="text-sm text-white ">Forgotten your password? Enter your e-mail address below, and we&apos;ll send
        ...
        <div>
            ...
            <button type="submit" className={`w-full text-white focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-brand-orange hover:bg-brand-orange-s  `}>
                Reset Password
            </button>
